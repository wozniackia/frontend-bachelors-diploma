...
<div className="flex-grow p-6 overflow-auto">
      ...
      <div className="flex justify-center items-end w-full gap-1 bg-gray-200 rounded-lg p-3">
        <div className="flex-grow">
          <label for="select" className="block mb-2 text-sm font-medium text-gray-900 ">Imię, Nazwisko, Grupa</label>
      ...
      <div className="flex flex-col my-3 gap-1">
        <div className="flex px-4 py-2 justify-between items-center rounded-lg bg-white border border-solid border-gray-300">
          ...
          <div className="flex flex-col justify-between items-center text-s font-medium text-gray-900">
            <span className="bg-green-200 text-green-500 px-2 rounded-full">Misie</span>
        ...
        <div className="flex px-4 py-2 justify-between items-center rounded-lg bg-white border border-solid border-gray-300">
          <div className="flex flex-col font-medium text-gray-900">
            ...
            <span className="text-sm">Rodzice: Mirosław Kowalski, Ewa Kowalska</span>
          </div>
          <div className="flex flex-col justify-between items-center text-s font-medium text-gray-900">
            <span className="bg-red-200 text-red-500 px-2 rounded-full">Tygryski</span>
        ...
        <div className="flex px-4 py-2 justify-between items-center rounded-lg bg-white border border-solid border-gray-300">
          <div className="flex flex-col font-medium text-gray-900">
            ...
            <span className="text-sm">Rodzice: Wiesław Nowakowicz, Elżbieta Nowakowicz-Lis</span>
          </div>
          <div className="flex flex-col justify-between items-center text-s font-medium text-gray-900">
            <span className="bg-orange-200 text-orange-500 px-2 rounded-full">Pantery</span>
        ...
        <div className="flex px-4 py-2 justify-between items-center rounded-lg bg-white border border-solid border-gray-300">
          <div className="flex flex-col font-medium text-gray-900">
            ...
            <span className="text-sm">Rodzice: Albert Kwiatek, Małgorzata Kwiatek</span>
          </div>
          <div className="flex flex-col justify-between items-center text-s font-medium text-gray-900">
            <span className="bg-red-200 text-red-500 px-2 rounded-full">Tygryski</span>
